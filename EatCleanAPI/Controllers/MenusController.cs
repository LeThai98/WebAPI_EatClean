...
namespace EatCleanAPI.Controllers
{
   // [Authorize]
    ...
    public class MenusController : ControllerBase
    {
        ...
        // GET: api/Menus/5
        [HttpGet("GetMenuWithProduct/{id}")]
        public async Task<ActionResult<Menu>> GetMenuWithProduct(int id)
        {
            var menu = await _context.Menus.
                Include(menu => menu.MenuDetails)
                    .ThenInclude(menudetail => menudetail.Product)
